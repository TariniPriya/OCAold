...
public class Register extends AppCompatActivity {
    ...
    private TextInputEditText editFullName, editEmail, editContact, editDob, editGender, editPassword, editConfirmPassword;
                        ...
                        if (task.isSuccessful()) {
                            ...
                            documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Signup Successful! Please Login now!", Toast.LENGTH_SHORT).show();
